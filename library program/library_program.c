...
void menu()
{
    ...
    printf("2. Calculate the square root.\n");
    printf("3. Calculate the cube root.\n");
    printf("4. Calculate the factorial.\n");
    printf("5. Calculate the combinations.\n");
    printf("6. Calculate the placing.\n");
    printf("7. Calculate the Pascal triangle.\n");
    printf("8. Calculate the sum arithmetic progression.\n");
    printf("9. Calculate the sum geometric progression.\n");
    printf("10. Calculate the sum infinity geometric progression.\n");
    printf("Enter number:\n");
}
...
int factorial_result()
{
    ...
    int n, fact;
    printf("\nEnter n - the number from which you want to find the factorial: ");
    n = IsInt(n);
...
float sum_infinity_geometric_progression_result()
{
    ...
    sum_infinity_geometric_progression(b_1, q);
    printf("\nResult: %0.2f", s);
}
...
/* This function reads the menu item entered by the user and calls up the required function.
...
int main(void) 
{
    ...
    while (choice != 0) 
    {
        // Display menu.
        menu();
        // Reads the menu item entered by the user and calls up the required function.
        function_calls();
